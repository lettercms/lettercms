...
import {RequestOptions, ListResponseMessage, AccountRequestOptions} from '../types';
...
class Accounts {
  ...
  async all(data?: RequestOptions): Promise<ListResponseMessage<AccountResponse>> {
    return this.parent.createRequest('/account', data);
  }
  async collaborators(data?: AccountRequestOptions): Promise<ListResponseMessage<AccountResponse>> {
