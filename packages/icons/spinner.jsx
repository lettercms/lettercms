export default function Spinner({fill, ...opts}) {
  return <svg {...opts} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="16 -16 38 38">
  <g>  
    ...
    <stop  offset="0.2" style={{stopColor: '#FFFFFF', stopOpacity: '0.5'}}/>
    <stop  offset="1" style={{stopColor: '#FFFFFF'}}/>
    </linearGradient>
    <path className="st0" fill={fill} d="M34.9-9c1.6,0,3.1,0.3,4.6,0.9c1.5,0.6,2.8,1.5,4,2.6c1.1,1.1,2,2.5,2.7,4C46.7,0,47,1.4,47,3s-0.3,3-0.8,4.5
    ...
    <path className="st1" fill={fill} d="M35.1,15c-1.6,0-3.1-0.3-4.6-0.9c-1.5-0.6-2.8-1.5-4-2.6s-2-2.5-2.7-4C23.3,6,23,4.6,23,3s0.3-3,0.8-4.5
    ...
    <glyph unicode="&#xe910;" glyphName="spin" d="M34.9-9c1.6,0,3.1,0.3,4.6,0.9c1.5,0.6,2.8,1.5,4,2.6c1.1,1.1,2,2.5,2.7,4C46.7,0,47,1.4,47,3s-0.3,3-0.8,4.5
    c0,0.1-0.1,0.2-0.2,0.3C45.9,7.9,45.9,8,45.8,8c-0.3,0.3-0.6,0.4-1,0.4c-0.4,0-0.8-0.1-1-0.4c-0.4-0.4-0.5-0.9-0.3-1.6
    c0.6-1.3,0.9-2.6,0.9-4.1s-0.2-2.8-0.7-4.2c-0.5-1.4-1.3-2.6-2.4-3.7c-1.3-1.3-2.7-2.1-4.4-2.6c-1.6-0.5-3.4-0.6-5-0.3
    c-1.7,0.3-3.3,1.1-4.7,2.1c1.1-0.9,2.3-1.6,3.7-2.1C32.2-8.7,33.5-9,34.9-9L34.9-9z" /> 
    <glyph unicode="&#xe910;" glyphName="spin" d="M34.9-9c1.6,0,3.1,0.3,4.6,0.9c1.5,0.6,2.8,1.5,4,2.6c1.1,1.1,2,2.5,2.7,4C46.7,0,47,1.4,47,3s-0.3,3-0.8,4.5
