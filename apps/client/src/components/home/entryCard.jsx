  ...
  return <div className='flex flex-col mx-3 my-16 md:w-2/5 lg:w-full lg:flex-row-reverse'>
    <div className='lg:w-2/3'>
      <div className='flex items-center'>
        <div className='shrink-0 basis-32 w-32 h-32 bg-cover bg-center rounded-lg' style={{backgroundImage: `url(${thumbnail}&h=250)`}}/>
        <h3 className='px-1 text-lg'>{title}</h3>
      </div>
    ...
    <div className='lg:flex lg:flex-col-reverse lg:justify-between lg:w-1/3'>
      <div className='flex justify-between items-end my-4 lg:flex-col'>
        ...
        <div className='flex flex-row-reverse items-end lg:px-4 lg:items-center'>
          <div className='w-12 h-12 bg-cover bg-center rounded-full shrink-0' style={{backgroundImage: `url(${author.photo}&w=150)`}}/>
          <h4 className='mx-2'>{author.name} {author.lastname}</h4>
        </div>
      </div>
