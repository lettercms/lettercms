...
import collabAccount from '../../../src/pages/api/_public/account/collaborator';
import {Accounts} from '@lettercms/models/accounts';
import jwt from 'jsonwebtoken';

let id = null;
const testID = 'collab-accounts';
...
describe('Accounts API Testing - /account/collaborator', () => {
  ...
  test('GET - Fields Data', async () => {
    const promises = [
      ...
      generatePromise('email',  'collab-account@test.com'),
      generatePromise('role',  'collaborator')
    ];
