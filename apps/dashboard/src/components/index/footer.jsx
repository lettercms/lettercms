...
const Footer = ({isPost}) => {
  return <>
    <svg className="footer-frame" style={{background: isPost ? 'white' : null}} data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1920 79"><defs><style>{'.cls-2{fill:#5f4def;}'}</style></defs><title>footer-frame</title><path className="cls-2" d="M0,72.427C143,12.138,255.5,4.577,328.644,7.943c147.721,6.8,183.881,60.242,320.83,53.737,143-6.793,167.826-68.128,293-60.9,109.095,6.3,115.68,54.364,225.251,57.319,113.58,3.064,138.8-47.711,251.189-41.8,104.012,5.474,109.713,50.4,197.369,46.572,89.549-3.91,124.375-52.563,227.622-50.155A338.646,338.646,0,0,1,1920,23.467V79.75H0V72.427Z" transform="translate(0 -0.188)"/></svg>
            ...
            <div className="footer-col middle">
              ...
              <ul className="list-unstyled li-space-lg p-small">
                <li className="media">
                  ...
                  <div className="media-body">Creador por <a className="white" href="#your-link">facebook.com/davidsdevel</a></div>
                </li>
                <li className="media">
                  <i className="fas fa-square"></i>
                  <div className="media-body">Lee nuestros <Link href='/terminos'><a className="white">Terminos y Condiciones</a></Link>, <Link href='/privacy'><a className="white">Politica de Privacidad</a></Link></div>
                </li>
              </ul>
            </div>
          </div> 
